...
public class LangConst {
	...
	public static TwoTuple<Integer, String> userRegisterInviteCodeError = new TwoTuple<Integer, String>(10210, "注册邀请码错误！");
	public static TwoTuple<Integer, String> userRegisterRegister = new TwoTuple<Integer, String>(10220, "注册已注册！");
	...
	public static TwoTuple<Integer, String> userLoginNotCertification = new TwoTuple<Integer, String>(10320, "登录实名认证错误！");
