<!DOCTYPE html>
<!-- saved from url=(0038)https://star.8.163.com/m#/originRecord -->
...
<script type="text/javascript" charset="utf-8" async=""
	src="./原力记录_files/0-0d12f68c.js.下载"></script>
<script type="text/javascript" charset="utf-8" async=""
	src="./原力记录_files/11-e14f1743.js.下载"></script>
</head>
<body>
	...
	<div id="app">
		<!---->
		<div data-v-5f4f905e="" class="originRecord">
			<section data-v-5f4f905e="" class="head">
				<h3 data-v-5f4f905e="" class="head-title">当前原力值</h3>
				<div data-v-5f4f905e="" class="head-text">${power}</div>
			</section>
			<section data-v-5f4f905e="" class="module__block top-margin">
				...
				<div class="module__box text"
					...
					原力是用户获取黑钻的影响因子，原力越高，获得的黑钻越多。可以通过在星球上进行浏览、学习、社交等活动，获取原力，由于目前星球基地正在前期搭建中，未来将支持更多获取原力的方式。
				</div>
			</section>
			<section data-v-5f4f905e="" class="module__fetch">
				<!---->
				<section data-v-5f4f905e=""
					class="module__block top-margin bottom-margin">
					<h3 class="module__title">
						收支记录
						<!---->
					</h3>
	...
	<script type="text/javascript"
		src="./原力记录_files/manifest-cbd2180a.js.下载"></script>
	<script type="text/javascript" src="./原力记录_files/vendor-4f9e6f25.js.下载"></script>
	<script type="text/javascript" src="./原力记录_files/app-1fe48405.js.下载"></script>
</body>
</html>